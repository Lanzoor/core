type FontIdentifier = 'geist' | 'space-grotesk' | 'jetbrains-mono' | 'fira-code' | 'fairfax-hd' | 'brass-mono';

const fonts: FontIdentifier[] = ['geist', 'space-grotesk', 'jetbrains-mono', 'fira-code', 'fairfax-hd', 'brass-mono'];
